    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-32 px-6">
        <div className="text-center space-y-6 max-w-2xl">
          <h1 className="text-5xl font-black uppercase tracking-tighter text-white">Product Overview</h1>
          <p className="text-xl text-white/50">
            This is a temporary page for the Product section. Detailed features and solutions will be displayed here soon.
          </p>
        </div>
      </main>
    </div>
